...
import nav.script.BasicScript.Code;
import nav.script.BasicScript.Instruction;
import nav.script.BasicScript.Trace;
...
public class Eval {
	...
	private void raise(String arg) {
		final String classname = BasicScript.class.getName();
